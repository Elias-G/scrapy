...
.. class:: Request(url[, callback, method='GET', headers, body, cookies, meta, encoding='utf-8', priority=0, dont_filter=False, errback, flags, encodeUrl])
    ...
    :param encodeUrl: indicates that this request's url should be escaped according
       to RFC-3986 standard via w3lib.url library. When bool is set to False the url
       will not be escaped. Default to ``True``.
    ...
    .. method:: Request.replace([url, method, headers, body, cookies, meta, encoding, dont_filter, callback, errback, encodeUrl])
